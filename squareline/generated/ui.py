...
ui_Second_Arc.set_range(0,30000)
ui_Second_Arc.set_value(20000)
ui_Second_Arc.set_bg_angles(0,360)
ui_Second_Arc.set_rotation(270)
...
ui_Second_Arc.set_style_arc_rounded( False, lv.PART.INDICATOR | lv.STATE.DEFAULT )
