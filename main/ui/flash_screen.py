...
class FlashScreen(Screen):
    def __init__(self):
        ...
        self.ui_Flash_Label5.set_style_text_font(self.resourceManager.load_font("F1B",24), lv.PART.MAIN | lv.STATE.DEFAULT)
    ...
    def Flash_eventhandler(self,event_struct):
        ...
        if event == lv.EVENT.SCREEN_LOADED and True:
            self.Flash_Animation(self.ui_Flash_Label5, 100)
        return
