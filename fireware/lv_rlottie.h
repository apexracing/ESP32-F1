...
lv_obj_t * lv_rlottie_create_from_raw_range(lv_obj_t * parent, lv_coord_t width, lv_coord_t height,
                                      const char * rlottie_desc,const size_t start,const size_t end);
